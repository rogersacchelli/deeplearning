...
(https://www.tensorflow.org/versions/r0.7/api_docs/python/nn.html#relu) and 1024 hidden nodes. T
his model should improve your validation / test accuracy.

---
'''

## FOR THIS PROBLEM WE NEED TO MAP OUTPUT FROM INPUT * (W) + B, TO 1024 SPACE:
## SO [1,784] * [784,1024] + [1,1024] = [1,1024] + [1,1024] = [1,1024]

print ('\n--- inserting 1024 nodes relu layer in between ---\n')
